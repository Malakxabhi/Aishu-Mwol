...
module.exports = {
    ...
    BOTPLK: process.env.BOT_NAME === undefined ? 'Aishu-Mwol' : process.env.BOT_NAME,
    ...
    CAPTION_KEY: process.env.CAPTION_KEY === undefined ?'Made by Aishu-Mwol' : process.env.CAPTION_KEY,
